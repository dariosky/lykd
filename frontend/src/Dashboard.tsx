          ...
          <div className="dashboard-card">
            ...
            <div className="card-content">
              <div className="activity-placeholder">
                <p>Your music activity will appear here once you start using the app.</p>
              </div>
            </div>
          </div>
          ...
          <div className="dashboard-card">
            ...
            <div className="card-content">
              <div className="friends-placeholder">
                <p>Connect with friends to start sharing music recommendations.</p>
              </div>
            </div>
          </div>
          ...
          <div className="dashboard-card">
            ...
            <div className="card-content">
              <div className="recommendations-placeholder">
                <p>Personalized music recommendations will appear here based on your network's activity.</p>
              </div>
            </div>
          </div>
        </div>

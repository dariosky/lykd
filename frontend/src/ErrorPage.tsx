...
function ErrorPage({ onGoHome, errorType = 'generic', customTitle, customMessage }: ErrorPageProps) {
  ...
  useEffect(() => {
    ...
    const finalMessage = customMessage || urlMessage || getDefaultMessage(finalErrorType)

    ...
    <div className="ignored-page">
      <div className="ignored-page-header">
        ...
        <p className="ignored-description">
          ...
          appear in your activity feeds or affect your stats.
        </p>
        <p>
          If you believe an item should be hidden for everyone, you can "report"
          it for global exclusion. An admin will review the request and decide
          whether to approve it. This is typically used for white-noise
          playlists or other non-musical content.
        </p>
      </div>

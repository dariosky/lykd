      ...
      <main className="homepage-main">
        <div className="welcome-section">
          <p className="welcome-description">
            ...
            personalized suggestions based on what your network is listening to.
          </p>
        </div>

        <div className="connect-section">
          {authError ? (
            <div className="server-issue-message error-message">
              <h3>Lykd is having some issue 😶</h3>
              <p className="server-issue-subtext">We will be back soon</p>
            </div>
          ) : (
            <>
              {" "}
              ...
              <p className="connect-description">
                Connect your Spotify account to begin sharing your music taste
        ...
        <div className="features-section">
          ...
          <div className="features-grid">
            <div className="feature-card">
              ...
              <p>
                Let your friends know about the songs you're loving right now
              </p>
            </div>
            ...
            <div className="feature-card">
              ...
              <p>
                Discover new music based on what your network is listening to
              </p>
            </div>
            ...
            <div className="feature-card">
              ...
              <p>
                Remove duplicates from your Spotify likes and sync your
                favourites to a sharable playlist
              </p>
            </div>
          </div>
        </div>
